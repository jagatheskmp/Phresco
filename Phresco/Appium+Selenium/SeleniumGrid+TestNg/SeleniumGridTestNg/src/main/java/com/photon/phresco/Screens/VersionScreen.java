...
public class VersionScreen {
	...
	public VersionScreen(String selectedBrowser, String selectedPlatform,
			String applicationURL, String applicationContext,
			UserInfoConstants userInfoConstants, UIConstants uiConstants,
			PhrescoUiConstants phrescoUiConstants,String selectedVersion) throws AWTException,
		...
		try {
			instantiateBrowser(selectedBrowser, selectedPlatform,
					applicationURL, applicationContext, selectedVersion);
	...
	public void instantiateBrowser(String selectedBrowser,
			...
			String applicationContext,String selectedVersion) throws ScreenException,
		...
		if (selectedBrowser.equalsIgnoreCase(Constants.BROWSER_CHROME)) {
			...
			capabilities.setVersion(selectedVersion);
