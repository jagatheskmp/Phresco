...
@Test(groups = { "all" })
public class GroupWisePriorityEshop {
	...
	public void verifyAudioDevicesP1()
	...
	@Test(groups = { "group2"},priority=10)
	public void verifyVideoGames10()
	 		throws InterruptedException, IOException, Exception {
	 	try {
	...
	@Test(groups = { "group2"},priority=3)
	 public void verifyTelevisionP3()
	 		throws InterruptedException, IOException, Exception {
	 	try {
