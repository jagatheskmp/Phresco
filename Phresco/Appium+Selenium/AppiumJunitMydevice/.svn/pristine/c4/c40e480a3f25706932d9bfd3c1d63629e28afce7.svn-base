...
@Test(groups = { "all" })
public class DataProviderEshop {
	...
	@Test(dataProvider = "jqueryMobilewidgetdata", dataProviderClass = com.photon.phresco.uiconstants.TestDataProvider.class,groups = { "group1"})
	public void verifyAudioDevices(Mobilewidget mobilewidget)
	...
	@Test(dataProvider = "jqueryMobilewidgetdata", dataProviderClass = com.photon.phresco.uiconstants.TestDataProvider.class,groups = { "group1" })
	public void verifyCameras(Mobilewidget mobilewidget)
	 ...
	 @Test(dataProvider = "jqueryMobilewidgetdata", dataProviderClass = com.photon.phresco.uiconstants.TestDataProvider.class,groups = { "group2" })
	public void verifyVideoGames(Mobilewidget mobilewidget)
	 		throws InterruptedException, IOException, Exception {
	 	try {
	 ...
	 @Test(dataProvider = "jqueryMobilewidgetdata", dataProviderClass = com.photon.phresco.uiconstants.TestDataProvider.class,groups = { "group2" })
	 public void verifyTelevision(Mobilewidget mobilewidget)
	 		throws InterruptedException, IOException, Exception {
	 	try {
