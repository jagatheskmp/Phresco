		...
		buildMbExtruder: function(options){
			return this.each (function (){
				...
				if (extruder.attr("extUrl")){
					...
					var container=$("<div>").addClass("text").css({width:extruder.get(0).options.width-0, height:extruder.height()-0, overflowY:"auto"});
				...
				if (isVertical){
					...
					if(this.options.top=="auto") {
						flap.css({top:290+(this.options.position=="left"?document.extruder.left:document.extruder.right)});
