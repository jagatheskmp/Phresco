(function ($) {
	...
	$.datepicker._updateDatepicker = function (inst) {
		...
		bottomLayer.append("<div class='hourdiv'> Time (HH:MM)</div>");
	...
	function DateTimePicker(options) {
		...
		hourHTML = $("<select class='dateimepicker-hour' ></select>");
		minutsHTML = $("<select class='dateimepicker-minuts' ></select>");
	...
	DateTimePicker.prototype = {
		...
		innerOption: function ($this) {
			...
			return {
				showOn: "button",
				//buttonImage: "../themes/default/images/bestbuy/calendar.gif",
