...
public class InvalidfileuploadPageTest  {
 ...
 @Test
 public void addInvalidCustomeModules()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testInvalidCustomeModules()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			/*baseScreen.validLoginAdminUI(methodName);*/
			invalidjarBase.InvalidCustomeModules(methodName);
 ...
 @Test
 public void testInvalidCustomModuleCreation()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testInvalidCustomModuleCreation()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			/*baseScreen.validLoginAdminUI(methodName);*/
			invalidjarBase.InvalidCustomModuleCreation(methodName);
 ...
 @Test
 public void testInvalidExternalModuleCreation()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testInvalidExternalModuleCreation()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			/*baseScreen.validLoginAdminUI(methodName);*/
			invalidjarBase.InvalidExternalModuleCreation(methodName);
 		...
 		@Test
 		public void testaddinvalidFileExternalArchetypes()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testaddinvalidFileExternalArchetypes()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			/*baseScreen.validLoginAdminUI(methodName);*/
			invalidjarBase.addinvalidFileExternalArchetypes(methodName);
 		...
 		@Test
 		public void testaddinvalidFileCustomArchetypes()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testaddinvalidFileCustomArchetypes()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			/*baseScreen.validLoginAdminUI(methodName);*/
			invalidjarBase.addinvalidFileCustomArchetypes(methodName);
 		...
 		@Test
 		public void testaddInvalidFileJsLibrariesCreation()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testaddInvalidFileJsLibrariesCreation()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			/*baseScreen.validLoginAdminUI(methodName);*/
			invalidjarBase.addInvalidFileJsLibrariesCreation(methodName);
