...
@Test
public void testExternalModuleCreationSelectingDefault()throws InterruptedException, IOException, Exception{
	try {

		System.out.println("---------testExternalModuleCreationSelectingDefault()-------------");
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		
		baseScreen.ExternalModuleCreationSelectingDefault(methodName);
...
public void testExternalModuleCreationWithoutSelectingDefault()throws InterruptedException, IOException, Exception{
	try {

		System.out.println("---------testExternalModuleCreationWithoutSelectingDefault()-------------");
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		
		baseScreen.ExternalModuleCreationWithoutSelectingDefault(methodName);
