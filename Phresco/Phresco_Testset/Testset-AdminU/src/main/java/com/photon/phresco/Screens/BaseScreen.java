...
public class BaseScreen {
	...
	public  void invalidUsernameValidPassword(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
		...
		try {
			...
			element=getXpathWebElement(uiConstants.LOGIN_USERNAME);
			waitForElementPresent(uiConstants.LOGIN_USERNAME,methodName);
			type(userInfoConstants.INVALID_USERNAME);
			Thread.sleep(1000);
			...
			isTextPresent(adminUIConstants.INVALID_USERNAME_PASSWORDS_MSG);
	...
	public  void validUsernameInvalidPassword(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
		...
		try {
			...
			element=getXpathWebElement(uiConstants.LOGIN_PASSWORD);
			waitForElementPresent(uiConstants.LOGIN_PASSWORD,methodName);
			type(userInfoConstants.INVALID_PASSWORD);
			Thread.sleep(1000);
	...
	public  void invalidUsernameInvalidPassword(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
	...
	public  void witoutUsernamePassword(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
	...
	public  void invalidUsernameEmptyPassword(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
		...
		try {
			...
			isTextPresent(adminUIConstants.INVALID_USERNAME_EMPTY_PASSWORD_MSG);
	...
	public  void validUsernameEmptyPassword(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
	...
	public  void dashboardPage(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
		...
		try {
			...
			getXpathWebElement(uiConstants.DADHBOARD_LINK);
			click();
			isTextPresent(adminUIConstants.DASHBOARD_PAGE_VERIFICATION);
	...
	public  void componentsPageValidation(String methodName) throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
		}
		log.info("@testComponentsPageValidation::******executing validLoginAdminUI scenario****");
		try {
			waitForElementPresent(uiConstants.COMPONENTS_LINK, methodName);
			getXpathWebElement(uiConstants.COMPONENTS_LINK);
			click();
			Thread.sleep(2000);
			...
			getXpathWebElement(uiConstants.REASUABLE_COMPONENT_MODULES_TAB);
			click();
			Thread.sleep(2000);
			waitForElementPresent(uiConstants.REASUABLE_COMPONENTS_JSLIBRARIES_TAB, methodName);
			getXpathWebElement(uiConstants.REASUABLE_COMPONENTS_JSLIBRARIES_TAB);
			Thread.sleep(2000);
			click();
			waitForElementPresent(uiConstants.REASUABLE_COMPONENT_TAB, methodName);
			getXpathWebElement(uiConstants.REASUABLE_COMPONENTS_COMPONENT_TAB);
			click();
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			...
			public  void modulesPageWithoutMandatoryFieldsValidation(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
				...
				try {
				    ...
				    getXpathWebElement(uiConstants.ADD_MODULES_BUTTON);
					click();
					Thread.sleep(2000);			
					waitForElementPresent(uiConstants.MODULE_SAVE_BUTTON, methodName);
					getXpathWebElement(uiConstants.MODULE_SAVE_BUTTON);
					click();
					Thread.sleep(2000);
			...
			public  void jslibrariesPageWithoutMandatoryFieldsValidation(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
				...
				try {
				    ...
				    getXpathWebElement(uiConstants.JSLIBRARIES_ADD_BUTTON);
					click();
					Thread.sleep(2000);			
			...
			public  void componentPageWithoutMandatoryFieldsValidation(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
				...
				try {
				    ...
				    getXpathWebElement(uiConstants.COMPONENTS_ADD_BUTTON);
					click();
					Thread.sleep(2000);			
					waitForElementPresent(uiConstants.COMPONENTS_SAVE_BUTTON, methodName);
					getXpathWebElement(uiConstants.COMPONENTS_SAVE_BUTTON);
					click();
					Thread.sleep(2000);
					isTextPresent(adminUIConstants.EMPTY_ADD_MODULE_NAME_MSG);
			...
			public  void archetypeCancelButton(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
				log.info("@testArchetypeCancelButton::******executing validLoginAdminUI scenario****");
				try {
					waitForElementPresent(uiConstants.COMPONENTS_LINK, methodName);
					getXpathWebElement(uiConstants.COMPONENTS_LINK);
					click();
				    ...
				    getXpathWebElement(uiConstants.ARCHETYPES_TAB);
				    click();
				    waitForElementPresent(uiConstants.ARCHETYPES_CREATE_BUTTON, methodName);
				    getXpathWebElement(uiConstants.ARCHETYPES_CREATE_BUTTON);
				    click();
					Thread.sleep(2000);
				    waitForElementPresent(uiConstants.ARCHETYPES_CANCEL_BUTTON, methodName);
				    getXpathWebElement(uiConstants.ARCHETYPES_CANCEL_BUTTON);
				    click();
				    System.out.println("Cancel is working");
			...
			public  void archetypeSaveWithoutMandatoryFields(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
				log.info("@testArchetypeSaveWithoutMandatoryFields::******executing validLoginAdminUI scenario****");
				try {
					waitForElementPresent(uiConstants.COMPONENTS_LINK, methodName);
					getXpathWebElement(uiConstants.COMPONENTS_LINK);
					click();
				    ...
				    getXpathWebElement(uiConstants.ARCHETYPES_SAVE_BUTTON);
				    click();
			...
			public  void createArchetypeWithoutJar(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
			...
			public  void createArchetypeWithoutTechnologyVersion(String methodName) throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
			...
			public  void createArchetypeWithoutApplicableFeatures(String methodName) throws Exception {
...
public  void technologyGroupCreation(String methodName) throws Exception {
				...
				log.info("@testtechnologyGroupCreation::******executing validLoginAdminUI scenario****");
				try {
					waitForElementPresent(uiConstants.COMPONENTS_LINK, methodName);
					getXpathWebElement(uiConstants.COMPONENTS_LINK);
					click();
				    ...
				    getXpathWebElement(uiConstants.ARCHETYPES_TAB);
				    click();	
		            waitForElementPresent(uiConstants.TECHNOLOGY_GROUP, methodName);
		            getXpathWebElement(uiConstants.TECHNOLOGY_GROUP);
		            click();
		            waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_NAME_BUTTON, methodName);
		            getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_NAME_BUTTON);
		            click();
		            type(adminUIConstants.TECHNOLOGY_GROUP_NAME_VALUE);
		            
		            waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_DESCRIPTION, methodName);
		            getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_DESCRIPTION);
		            click();
		            type(adminUIConstants.TECHNOLOGY_GROUP_DESCRIPTION_VALUE);
		            
		            waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_ADD_BUTTON, methodName);
		            getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_ADD_BUTTON);
		            click();
		            waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_OKAY_BUTTON, methodName);
		            getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_OKAY_BUTTON);
		            click();
...
public  void technologyGroupCancelButton(String methodName) throws Exception {
	...
	log.info("@technologyGroupCancelButton::******executing validLoginAdminUI scenario****");
	try {
		waitForElementPresent(uiConstants.COMPONENTS_LINK, methodName);
		getXpathWebElement(uiConstants.COMPONENTS_LINK);
		click();
        ...
        getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_ADD_BUTTON);
        click();
        waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_CANCEL_BUTTON, methodName);
        getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_CANCEL_BUTTON);
        click();
...
public  void technologyGroupDeletion(String methodName) throws Exception {
	...
	log.info("@technologyGroupDeletion::******executing validLoginAdminUI scenario****");
	try {
		waitForElementPresent(uiConstants.COMPONENTS_LINK, methodName);
		getXpathWebElement(uiConstants.COMPONENTS_LINK);
		click();
        ...
        waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_SELECT_BUTTON, methodName);
        getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_SELECT_BUTTON);
        click();
        waitForElementPresent(uiConstants.TECHNOLOGY_GROUP_DELETE_BUTTON, methodName);
        getXpathWebElement(uiConstants.TECHNOLOGY_GROUP_DELETE_BUTTON);
        click();
		...
		e.printStackTrace();
			...
			public void  createArchetypeWithAnotherCustomer(String methodName)
			{
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
					log.info("@testAdminCustomerPage::******executing ArchetypesCreationForDifferentCustomers scenario****");
				}
				try {
					...
					waitForElementPresent(uiConstants.CUSTOMER_DROPDOWN_VALUE_BESTBUY,methodName);
					getXpathWebElement(uiConstants.CUSTOMER_DROPDOWN_VALUE_BESTBUY).click();
					Thread.sleep(10000);
			       ...
			       // Thread.sleep(2000);
					...
					click();
					type(adminUIConstants.ARCHETYPES_NAME_BESTBUY);
					//type(methodName);
					...
					System.out.println("--------------Upload archeytype File----------");
					driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\vairamuthu_m\\Desktop\\jars\\phresco-drupal7-archetype-2.0.0.34001.jar");
			...
			public void deleteArchetypeWithAnotherCustomer(String methodName)throws Exception {
				if (StringUtils.isEmpty(methodName)) {
					methodName = Thread.currentThread().getStackTrace()[1]
							.getMethodName();
				}
...
try {
  ...
  public void submit() throws ScreenException {
	...
	/// RBAC Service Admin Test case Starts here 
		...
		public  void ExternalModuleCreationSelectingDefault(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
		...
		public  void ExternalModuleCreationWithoutSelectingDefault(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			log.info("@testExternalModuleCreationWithoutSelectingDefault::******executing ExternalModuleCreationWithoutSelectingDefault scenario****");
			try {
		...
		public  void CustomeModulesSelectingDefault(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			log.info("@testCustomeModulesSelectingDefault::******executing CustomeModulesSelectingDefault scenario****");
			try {
		...
		public  void CustomeModulesWithoutSelectingDefault(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			log.info("@testCustomeModulesWithoutSelectingDefault::******executing CustomeModulesWithoutSelectingDefault scenario****");
			try {
		...
		public  void DefaultJsLibrariesCreation(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			log.info("@DefaultJsLibrariesCreation::******executing DefaultJsLibrariesCreation scenario****");
			try {
				Thread.sleep(2000);
				waitForElementPresent(uiConstants.COMPONENTS_LINK,methodName);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
		...
		public  void MandatoryFieldValidationJsLibrariesCreation(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			...
			try {
				...
				click();
				Thread.sleep(1000);	
				isTextPresent("Name is missing");
				isTextPresent("Select atleast one technology");
				isTextPresent("Select License Type");
				isTextPresent("File is missing ");
		...
		public  void MandatoryFieldValidationComponents(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			log.info("@MandatoryFieldValidationComponents::******executing MandatoryFieldValidationComponents scenario****");
			try {
				Thread.sleep(2000);
				waitForElementPresent(uiConstants.COMPONENTS_LINK,methodName);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
		...
		public void  AddDownloadFileForSever(String methodName)
		{
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
				log.info("@AddDownloadFileForSever::******executing AddDownloadFileForSever scenario****");
			}
			try {
				Thread.sleep(2000);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
				...
				System.out.println("--------------Upload File----------");
				driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\kalish_ma\\Desktop\\jars\\drupal-maven-plugin-2.0.0.6001-SNAPSHOT.jar");
				...
				Thread.sleep(2000);
				element=getXpathWebElement(uiConstants.DOWNLOAD_ADD_APPLICATION_PLATFORM_ALL);
				waitForElementPresent(uiConstants.DOWNLOAD_ADD_APPLICATION_PLATFORM_ALL, methodName);
				click();
				...
				System.out.println("--------------Recent uploaded Download is ----------" +adminUIConstants.ADD_COMPONENT_NAME_VALUE);
		...
		public void  AddDownloadFileForDataBase(String methodName)
		{
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
				log.info("@AddDownloadFileForDataBase::******executing AddDownloadFileForDataBase scenario****");
			}
			try {
				Thread.sleep(2000);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
				...
				waitForElementPresent(uiConstants.DOWNLOAD_ADD_GROUP, methodName);
				click();
				selectText(element,adminUIConstants.DOWNLOAD_ADD_GROUP_VALUE_DB);
				click();
				...
				Thread.sleep(2000);
				isTextPresent(adminUIConstants.ADD__CONFIGURATION_TEMPLETS_NAME);
				
				System.out.println("--------------Recent uploaded Download is ----------" +adminUIConstants.ADD__CONFIGURATION_TEMPLETS_NAME);
		...
		public void  AddDownloadFileForEditor(String methodName)
		{
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
				log.info("@AddDownloadFileForEditor::******executing AddDownloadFileForEditor scenario****");
			}
			try {
				Thread.sleep(2000);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
				...
				waitForElementPresent(uiConstants.DOWNLOAD_ADD_GROUP, methodName);
				click();
				selectText(element,adminUIConstants.DOWNLOAD_ADD_GROUP_VALUE_EDITOR);
				click();
				...
				System.out.println("--------------Recent uploaded Download is ----------" +adminUIConstants.ADD_JSLIBRARIES_NAME_VALUE);
		...
		public void  AddDownloadFileForTools(String methodName)
		{
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
				log.info("@AddDownloadFileForTools::******executing AddDownloadFileForTools scenario****");
			}
			try {
				Thread.sleep(2000);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
				...
				waitForElementPresent(uiConstants.DOWNLOAD_ADD_GROUP, methodName);
				click();
				selectText(element,adminUIConstants.DOWNLOAD_ADD_GROUP_VALUE_TOOLS);
				click();
				...
				System.out.println("--------------Recent uploaded Download is ----------" +adminUIConstants.ADD_MODULE_PHP_NAME_VALUE);
		...
		public void  AddDownloadFileForOthers(String methodName)
		{
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
				log.info("@AddDownloadFileForOthers::******executing AddDownloadFileForOthers scenario****");
			}
			try {
				Thread.sleep(2000);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
				...
				waitForElementPresent(uiConstants.DOWNLOAD_ADD_GROUP, methodName);
				click();
				selectText(element,adminUIConstants.DOWNLOAD_ADD_GROUP_VALUE_OTHERS);
				click();
		...
		public  void MandatoryFieldValidationDownloads(String methodName) throws Exception {
			if (StringUtils.isEmpty(methodName)) {
				methodName = Thread.currentThread().getStackTrace()[1]
						.getMethodName();
			}
			log.info("@MandatoryFieldValidationDownloads::******executing MandatoryFieldValidationDownloads scenario****");
			try {
				Thread.sleep(2000);
				waitForElementPresent(uiConstants.COMPONENTS_LINK,methodName);
				element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
				...
				isTextPresent("Select atleast one technology");
				isTextPresent("Select License Type");
				isTextPresent("Select group");
				isTextPresent("Select atleast one application");
