...
public class JsLibrariesPageTest {
	...
	@Test
	 ...
	 @Test
	 public void testDefaultJsLibrariesCreation()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testDefaultJsLibrariesCreation()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			
			baseScreen.DefaultJsLibrariesCreation(methodName);
	 ...
	 @Test
	 public void testMandatoryFieldValidationJsLibrariesCreation()throws InterruptedException, IOException, Exception{
		try {

			System.out.println("---------testMandatoryFieldValidationJsLibrariesCreation()-------------");
			methodName = Thread.currentThread().getStackTrace()[1]
					.getMethodName();
			
			baseScreen.MandatoryFieldValidationJsLibrariesCreation(methodName);
