...
@Test
public void testCustomeModulesSelectingDefault()throws InterruptedException, IOException, Exception{
	try {

		System.out.println("---------testCustomeModulesSelectingDefault()-------------");
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		
		baseScreen.CustomeModulesSelectingDefault(methodName);
	} catch (Exception t) {
		t.printStackTrace();
...
@Test
public void testCustomeModulesWithoutSelectingDefault()throws InterruptedException, IOException, Exception{
	try {

		System.out.println("---------testCustomeModulesWithoutSelectingDefault()-------------");
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
		
		baseScreen.CustomeModulesWithoutSelectingDefault(methodName);
	} catch (Exception t) {
		t.printStackTrace();
