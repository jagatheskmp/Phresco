...
public class InvalidJarBase {
	...
	public InvalidJarBase() {

	}


	public InvalidJarBase(String selectedBrowser, String selectedPlatform, String applicationURL,
...
public boolean waitForTextPresent(String text) throws InterruptedException, ScreenException {
	...
	public  void addInvalidJarModules(String methodName) throws Exception {
		 if (StringUtils.isEmpty(methodName)) {
			...
			try {
				...
				driver.findElement(By.name("file")).sendKeys("D:\\jars\\docs\\PHTN_Reference_Guide.doc");
			...
			//	Thread.sleep(8000);
				...
				isTextPresent(adminUIConstants.TEXT_ERROR_MSG);
	 ...
	 public void customerSelection(String methodName)throws Exception {
		  ...
		  public  void AddingTechnology(String methodName) throws Exception {
			  try {
					...
					if( methodName == "addInvalidJarPhpModules" || methodName == "addInvalidJarPhpJslibraries" || methodName == "addInvalidJarPHPComponents"|| methodName == "testPHPComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarDrupal6Modules" || methodName == "addInvalidJarDrupal6Jslibraries" || methodName == "addInvalidJarDrupal6Components"|| methodName == "testDrupal6ComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarDrupal7Modules" || methodName == "addInvalidJarDrupal7Jslibraries" || methodName == "addInvalidJarDrupal7Components"|| methodName == "testDrupal7ComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarWordPressModules" || methodName == "addInvalidJarWordPressJslibraries" || methodName == "addInvalidJarWordPressComponents"|| methodName == "testWordPressComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarMultiYUIModules" || methodName == "addInvalidJarMultiYUIJslibraries" || methodName == "addInvalidJarMultiYUIComponents"|| methodName == "testMultiYUIComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarMultiJQueryModules" || methodName == "addInvalidJarMultiJQueryJslibraries" || methodName == "addInvalidJarMultiJQueryComponents"|| methodName == "testMultiJQueryComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarYUIMobileModules" || methodName == "addInvalidJarYUIMobileJslibraries" || methodName == "addInvalidJarYUIMobileComponents"|| methodName == "testYUIMobileComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarJQueryMobileModules" || methodName == "addInvalidJarJQueryMobileJslibraries" || methodName == "addInvalidJarJQueryMobileComponents"|| methodName == "testJQueryMobileComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarDOTNETModules" || methodName == "addInvalidJarDOTNETJslibraries" || methodName == "addInvalidJarDOTNETComponents"|| methodName == "testDOTNETComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarSharePointModules" || methodName == "addInvalidJarSharePointJslibraries" || methodName == "addInvalidJarSharePointComponents"|| methodName == "testSharePointComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarSiteCoreModules" || methodName == "addInvalidJarSiteCoreJslibraries" || methodName == "addInvalidJarSiteCoreComponents"|| methodName == "testSiteCoreComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarNodejsModules" || methodName == "addInvalidJarNodejsJslibraries" || methodName == "addInvalidJarNodejsComponents"|| methodName == "testNodejsComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarJavaStandaloneModules" || methodName == "addInvalidJarJavaStandaloneJslibraries" || methodName == "addInvalidJarJavaStandaloneComponents"|| methodName == "testJavaStandaloneComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarJavaWebServiceModules" || methodName == "addInvalidJarJavaWebServiceJslibraries" || methodName == "addInvalidJarJavaWebServiceComponents"|| methodName == "testJavaWebServiceComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJariPhoneHybridModules" || methodName == "addInvalidJariPhoneHybridJslibraries" || methodName == "addInvalidJariPhoneHybridComponents"|| methodName == "testiPhoneHybridComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJariphoneNativeModules" || methodName == "addInvalidJariphoneNativeJslibraries" || methodName == "addInvalidJariphoneNativeComponents"|| methodName == "testiphoneNativeComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJariPhoneLibraryModules" || methodName == "addInvalidJariPhoneLibraryJslibraries" || methodName == "addInvalidJariPhoneLibraryComponents"|| methodName == "testiPhoneLibraryComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJariPhoneWorkSpaceModules" || methodName == "addInvalidJariPhoneWorkSpaceJslibraries" || methodName == "addInvalidJariPhoneWorkSpaceComponents"|| methodName == "testiPhoneWorkSpaceComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarAndroidHybridModules" || methodName == "addInvalidJarAndroidHybridJslibraries" || methodName == "addInvalidJarAndroidHybridComponents"|| methodName == "testAndroidHybridComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarAndroidNativeModules" || methodName == "addInvalidJarAndroidNativeJslibraries" || methodName == "addInvalidJarAndroidNativeComponents"|| methodName == "testAndroidNativeComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarAndroidLibraryModules" || methodName == "addInvalidJarAndroidLibraryJslibraries" || methodName == "addInvalidJarAndroidLibraryComponents"|| methodName == "testAndroidLibraryComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarWindowsMetroModules" || methodName == " addInvalidJarWindowsMetroJslibraries" || methodName == "addInvalidJarWindowsMetroComponents"|| methodName == "testWindowsMetroComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarWindowsPhoneModules" || methodName == "addInvalidJarWindowsPhoneJslibraries" || methodName == "addInvalidJarWindowsPhoneComponents"|| methodName == "testWindowsPhoneComponentsAddConfigurationTemplatePage")
					{
					...
					else if( methodName == "addInvalidJarBlackBerryHybridModules" || methodName == "addInvalidJarBlackBerryHybridJslibraries" || methodName == "addInvalidJarBlackBerryHybridComponents")
					{
			  ...
			  try {
				  ...
				  System.out.println("----------deleteRUC starts ----------");
					if(methodName == "testDeletePHPModules"||methodName == "testDeletePHPJSLibraries"||methodName == "testDeletePHPComponents")
					{
						...
						Thread.sleep(3000);
						element=getXpathWebElement(uiConstants.SELECT_TECHNOLOGY);
	  	...
	  	public  void addModules(String methodName) throws Exception {
			 if (StringUtils.isEmpty(methodName)) {
				...
				try {
					...
					System.out.println("--------------Upload File----------");
					driver.findElement(By.name("file")).sendKeys("D:\\Test\\Phresco-Build-2.0.0.32000\\phresco-framework\\tools\\maven\\lib\\aether-impl-1.11.jar");
		 ...
		 public  void addInvalidJSLibraries(String methodName) throws Exception {
			 if (StringUtils.isEmpty(methodName)) {
				...
				try {
					...
					//type(adminUIConstants.ADD_JSLIBRARIES_LICENSE_TYPE);
					click();
					Thread.sleep(3000);
		 ...
		 public  void addingInvalidJSLibraries(String methodName) throws Exception {
			 if (StringUtils.isEmpty(methodName)) {
	             methodName = Thread.currentThread().getStackTrace()[1]
	                             .getMethodName();
	     }
			...
			/*		waitForTextPresent("Android Hybrid");
					...
					getXpathWebElement(uiConstants.REASUABLE_COMPONENT_TAB);
					waitForElementPresent(uiConstants.REASUABLE_COMPONENT_TAB,methodName);
					click();
					Thread.sleep(2000);
					
					getXpathWebElement(uiConstants.JSLIBRARIES_BUTTON);
					waitForElementPresent(uiConstants.JSLIBRARIES_BUTTON, methodName);
					click();
					Thread.sleep(2000);
					...
					waitForElementPresent(uiConstants.JSLIBRARIES_LICENSE_TYPE, methodName);
					click();
					getXpathWebElement(uiConstants.ADD_JSLIBRARIES_LICENSE_TYPE);
					waitForElementPresent(uiConstants.ADD_JSLIBRARIES_LICENSE_TYPE, methodName);
					click();
					Thread.sleep(8000);
					
					System.out.println("--------------Upload File----------");
					driver.findElement(By.xpath("//div[@id='feature-file-uploader']/div/div[2]/input")).sendKeys("C:\\Documents and Settings\\vairamuthu_m\\Desktop\\jars\\drupal-maven-plugin-2.0.0.6001-SNAPSHOT.jar");
					Thread.sleep(4000);
					System.out.println("--------------Upload File----------");
					
					isTextPresent(adminUIConstants.TEXT_ERROR_MSG);
					
					getXpathWebElement(uiConstants.JSLIBRARIES_SAVE_BUTTON);
					waitForElementPresent(uiConstants.JSLIBRARIES_SAVE_BUTTON, methodName);
					click();
		...
		public void addInValidArchetypeApplayer(String methodName) throws Exception{
			if(StringUtils.isEmpty(methodName)){
				methodName=Thread.currentThread().getStackTrace()[1].getMethodName();
			}
			
			log.info("@addInvalidArchetype:: executing addInvalidArchetypeApplayer");
			try{
				...
				Thread.sleep(3000);
				driver.findElement(By.xpath("//div[@id='appln-file-uploader']/div/div[2]/input")).sendKeys("C:\\Documents and Settings\\vairamuthu_m\\Desktop\\jars\\video1-1.0.mp4");
			    Thread.sleep(5000);
		...
		public void addInValidArchetypeWeblayer(String methodName) throws Exception{
			if(StringUtils.isEmpty(methodName)){
				methodName=Thread.currentThread().getStackTrace()[1].getMethodName();
			}
			
			log.info("@addInvalidArchetype:: executing addInvalidArchetypeWeblayer");
			try{
	...
	public void addInValidArchetypeMobilelayer(String methodName) throws Exception{
		if(StringUtils.isEmpty(methodName)){
			methodName=Thread.currentThread().getStackTrace()[1].getMethodName();
		}
	...
	public void  addInvalidPilotProject(String methodName)
	{
	 ...
	 click();*/
			...
			driver.findElement(By.xpath("")).sendKeys("C:\\Documents and Settings\\kalish_ma\\Desktop\\jars\\tech-nodejs-webservice-2.0.0.34001.zip");
	...
	public void addInvalidVideoFile(String methodName)throws Exception {
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1] .getMethodName();
		}
		try {
	...
	public void  addInvalidComponentInDownload(String methodName)
	{
		if (StringUtils.isEmpty(methodName)) {
			methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		public  void addInValidComponent(String methodName) throws Exception {
			 if (StringUtils.isEmpty(methodName)) {
				...
				try {
					...
					getXpathWebElement(uiConstants.COMPONENTS_LICENSE_TYPE);
					
					click();
				
					/*getXpathWebElement(adminUIConstants.ADD_COMPONENT_LICENSE_TYPE);
					waitForElementPresent(adminUIConstants.ADD_COMPONENT_LICENSE_TYPE, methodName);	
					Thread.sleep(1000);*/
				     selectText(element,adminUIConstants.ADD_COMPONENT_LICENSE_TYPE );	
				//	type(adminUIConstants.ADD_COMPONENT_LICENSE_TYPE);
					...
					System.out.println("--------------Upload File----------");
					driver.findElement(By.xpath("//input[@class='upload']")).sendKeys("C:\\Documents and Settings\\vairamuthu_m\\Desktop\\jars\\drupal-maven-plugin-2.0.0.6001-SNAPSHOT.jar");
					Thread.sleep(4000);
 ...
 if (StringUtils.isEmpty(methodName)) {
     ...
     try {
    	 		...
    	 		*/
    	 		...
    	 		System.out.println("--------------Upload archeytype File----------");
				driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\srividya_su\\Desktop\\archetype.jar");
...
if (StringUtils.isEmpty(methodName)) {
 ...
 try {
	...
	/* Thread.sleep(2000);
	 ...
	 Thread.sleep(3000);
	 System.out.println("--------------Upload Zip File----------");
		driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\srividya_su\\Desktop\\zipfolder.zip");
...
public  void InvalidCustomeModules(String methodName) throws Exception {
	if (StringUtils.isEmpty(methodName)) {
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
	}
	log.info("@testInvalidCustomeModules::******executing InvalidCustomeModules scenario****");
	try {
		...
		System.out.println("--------------Upload File----------");
		Thread.sleep(10000);
		driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\kalish_ma\\Desktop\\jars\\tech-html5-widget-2.0.0.34002.zip");
	    Thread.sleep(10000);         
...
public  void InvalidCustomModuleCreation(String methodName) throws Exception {
	if (StringUtils.isEmpty(methodName)) {
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
	}
	log.info("@InvalidCustomModuleCreation::******executing InvalidCustomModuleCreation scenario****");
	try {
		...
		System.out.println("--------------Upload File----------");
		driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\kalish_ma\\Desktop\\jars\\tech-php-2.0.0.34000.zip");

		Thread.sleep(3000);
		
	    isTextPresent("ZIP Folder Name and Feature Name Does Not Match ");
		System.out.println("--------------Invalid Custom Module----------");
...
public  void InvalidExternalModuleCreation(String methodName) throws Exception {
	if (StringUtils.isEmpty(methodName)) {
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
	}
	log.info("@testExternalModuleCreationSelectingDefault::******executing ExternalModuleCreationSelectingDefault scenario****");
	try {
	    ...
	    isTextPresent("ZIP Folder Name and Feature Name Does Not Match ");
		System.out.println("--------------Invalid External Module----------");
...
public void  addinvalidFileExternalArchetypes(String methodName)
{
	if (StringUtils.isEmpty(methodName)) {
		methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		log.info("@addinvalidFileExternalArchetypes::******executing addinvalidFileExternalArchetypes scenario****");
	}
	try {
		...
		System.out.println("--------------Upload archeytype File----------");
		driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\kalish_ma\\Desktop\\jars\\TestSet3.war");
		...
		Thread.sleep(2000);	
		//waitForElementPresent(uiConstants.PROJCREATIONSUCCESSMSG,methodName);
		waitForTextPresent("Choose only jar file ");
...
public void  addinvalidFileCustomArchetypes(String methodName)
{
	if (StringUtils.isEmpty(methodName)) {
		methodName = Thread.currentThread().getStackTrace()[1].getMethodName();
		log.info("@addinvalidFileCustomArchetypes::******executing addinvalidFileCustomArchetypes scenario****");
	}
	try {
...
public  void addInvalidFileJsLibrariesCreation(String methodName) throws Exception {
	if (StringUtils.isEmpty(methodName)) {
		methodName = Thread.currentThread().getStackTrace()[1]
				.getMethodName();
	}
	log.info("@addInvalidFileJsLibrariesCreation::******executing addInvalidFileJsLibrariesCreation scenario****");
	try {
		Thread.sleep(2000);
		waitForElementPresent(uiConstants.COMPONENTS_LINK,methodName);
		element=getXpathWebElement(uiConstants.COMPONENTS_LINK);
		...
		System.out.println("--------------Upload File----------");
		driver.findElement(By.name("file")).sendKeys("C:\\Documents and Settings\\kalish_ma\\Desktop\\jars\\php-plugin-2.0.0.23000.jar");
		...
		waitForElementPresent(uiConstants.JSLIBRARIES_SAVE_BUTTON, methodName);
		click();
		waitForTextPresent("Choose only js, zip or war file ");
		Thread.sleep(2000);
