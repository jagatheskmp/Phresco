...
public class HTML5MultichannelYUIWidgetConstantsxml {
    ...
    public String MULTICHANNEL_YUI_WIDGET_HELLOWORLD_PROJECT_CODE="multiYuiWidgetHelloworldCodeValue";
    public String MULTICHANNEL_YUI_WIDGET_HELLOWORLD_PROJECT_DESC="multiYuiWidgetHelloworldDescriptionValue";
    public String MULTICHANNEL_YUI_WIDGET_HELLOWORLD_PROJECT_VERSION="multiYuiWidgetHelloworldVersionValue";
	...
	public String MULTICHANNEL_YUI_WIDGET_ESHOP_PROJECT_CODE="multiYuiWidgetEshopCodeValue";
	public String MULTICHANNEL_YUI_WIDGET_ESHOP_PROJECT_DESC="multiYuiWidgetEshopDescriptionValue";
	public String MULTICHANNEL_YUI_WIDGET_ESHOP_PROJECT_VERSION="multiYuiWidgetEshopVersionValue";
	...
	public String MULTICHANNEL_YUI_WIDGET_ESHOP_PROJECT_CHECKBOX="multiYuiMobWidgetEshopCheckBoxXpath";
	public String MULTICHANNEL_YUI_WIDGET_ESHOP_PROJECT_LINK="multiYuiMobWidgetEshopEditApplicationLinkXpath";
    ...
    public String MULTICHANNEL_YUI_WIDGET_ESHOP_SERVER_CONTEXT_VALUE="multiYuiServContextValueEshop";
 	...
 	public String MULTICHANNEL_YUI_WIDGET_ESHOP_WEBSERVICE_CONTEXT_VALUE="multiYuiWebserviceContextEshopValue";
