...
public class PhrescoUiConstantsXml {
	...
	public String CODE_MENU_TAB = "codeMenuTab";
	public String SONAR_NOT_STARTED = "sonarNotStarted";
	public String CODE_VALIDATE_BUTTON = "codeValidateButton";
	public String CODE_AGAINST = "codeAgainst";
	public String CODE_TECHNOLOGY = "codeTechnology";
	public String CODE_SKIP_UNIT_TEST = "codeSkipUnitTest";
	public String CODE_OK_BUTTON = "codeOk";
	public String CODE_SOURCE_VALUE = "codeSourceValue";
	public String CODE_FUNCTIONAL_TEST_VALUE = "codeFunctionalValue";
	/*public String CODE_JS_VALUE = "codeAgainstJsValue";
	public String CODE_JAVA_VALUE = " codeAgainstJavaValue";*/
	public String CODE_JSF_VALUE = "codeAgainstJsfValue";
	public String CODE_HTML_VALUE = "codeAgainstHtmlValue";
