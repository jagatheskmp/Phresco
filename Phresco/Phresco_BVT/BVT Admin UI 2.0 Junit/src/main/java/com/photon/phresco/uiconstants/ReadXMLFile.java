...
public class ReadXMLFile {
	...
	private static final String adminUI = "./src/main/resources/AdminUIData.xml";
	private static final String constants = "./src/main/resources/UIConstants.xml";
	private static final String UsrInfoConst="./src/main/resources/UserInfo.xml";
	...
	public void loadAdminUIData() throws ScreenException {
    	loadPhrescoConstansts(adminUI);
	}
	...
	public void loadUserInfoConstants() throws ScreenException {
		loadPhrescoConstansts(UsrInfoConst);
